...
var $author$project$Main$Model = F2(
	function (addGoalTitle, goals) {
		return {addGoalTitle: addGoalTitle, goals: goals};
	});
...
var $author$project$Tailwind$Utilities$m_8 = A2($rtfeldman$elm_css$Css$property, 'margin', '2rem');
...
var $author$project$Tailwind$Utilities$shadow = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
	...
	[
		...
		_List_fromArray(
			[
				...
				A2($rtfeldman$elm_css$Css$property, '--tw-contain-size', ' '),
				A2($rtfeldman$elm_css$Css$property, '--tw-contain-layout', ' '),
				A2($rtfeldman$elm_css$Css$property, '--tw-contain-paint', ' '),
				A2($rtfeldman$elm_css$Css$property, '--tw-contain-style', ' ')
			])),
		A2(
		$rtfeldman$elm_css$Css$Global$selector,
		'::backdrop',
		...
		_List_fromArray(
			[
				...
				A2($rtfeldman$elm_css$Css$property, 'font-family', 'ui-sans-serif, system-ui, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\"'),
		...
		_List_fromArray(
			[
				...
				A2($rtfeldman$elm_css$Css$property, 'font-weight', 'inherit'),
				A2($rtfeldman$elm_css$Css$property, 'line-height', 'inherit'),
				A2($rtfeldman$elm_css$Css$property, 'letter-spacing', 'inherit'),
				A2($rtfeldman$elm_css$Css$property, 'color', 'inherit'),
				A2($rtfeldman$elm_css$Css$property, 'margin', '0'),
...
var $author$project$StyledHtml$styledHtml = function (html) {
...
var $author$project$Icons$target = function (dimensions) {
	var dimensionAttrs = function () {
		if (dimensions.$ === 'Just') {
			var dims = dimensions.a;
			return _List_fromArray(
				[
					$rtfeldman$elm_css$Svg$Styled$Attributes$width(
					A2($elm$core$Maybe$withDefault, '24', dims.width)),
					$rtfeldman$elm_css$Svg$Styled$Attributes$height(
					A2($elm$core$Maybe$withDefault, '24', dims.height))
				]);
		} else {
			return _List_fromArray(
				[
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Svg$Styled$Attributes$opacity('0')
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Svg$Styled$Attributes$transform('matrix(0.83 0 0 0.83 12 12)')
					]),
				_List_fromArray(
					[
						A2(
	...
	return $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				...
				$elm$core$Maybe$Just('--tw-bg-opacity, 1'),
				color)
			]));
};
...
var $author$project$Tailwind$Theme$gray_200 = A5($matheus23$elm_tailwind_modules_base$Tailwind$Color$Color, 'rgb', '229', '231', '235', $matheus23$elm_tailwind_modules_base$Tailwind$Color$ViaVariable);
...
var $author$project$Tailwind$Theme$opacity50 = $matheus23$elm_tailwind_modules_base$Tailwind$Color$Opacity('0.5');
var $author$project$Icons$plus = function (dimensions) {
	var dimensionAttrs = function () {
		if (dimensions.$ === 'Just') {
			var dims = dimensions.a;
			return _List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Svg$Styled$Attributes$d('M 11 2 L 11 11 L 2 11 L 2 13 L 11 13 L 11 22 L 13 22 L 13 13 L 22 13 L 22 11 L 13 11 L 13 2 Z'),
								$rtfeldman$elm_css$Svg$Styled$Attributes$strokeLinecap('round'),
								$rtfeldman$elm_css$Svg$Styled$Attributes$transform('translate(-12, -12)')
							]),
						_List_Nil)
					]))
			]));
};
var $author$project$Tailwind$Utilities$px_2 = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Tailwind$Utilities$text_xs = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, 'font-size', '0.75rem'),
			A2($rtfeldman$elm_css$Css$property, 'line-height', '1rem')
		]));
var $author$project$Tailwind$Utilities$transition_colors = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, 'transition-property', 'color, background-color, border-color, text-decoration-color, fill, stroke'),
...
var $author$project$Main$viewAddGoalButton = A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					$author$project$Tailwind$Utilities$text_xs,
					$author$project$Tailwind$Utilities$px_2,
					$author$project$Tailwind$Utilities$py_1,
					$author$project$Tailwind$Utilities$font_semibold,
					$author$project$Tailwind$Utilities$transition_colors,
					$rtfeldman$elm_css$Css$hover(
					_List_fromArray(
						[
							$author$project$Tailwind$Utilities$bg_color(
							A2($matheus23$elm_tailwind_modules_base$Tailwind$Color$withOpacity, $author$project$Tailwind$Theme$opacity50, $author$project$Tailwind$Theme$gray_200))
						]))
				]))
		]),
	_List_fromArray(
		[
			...
			$elm$core$Maybe$Just(
				{
					height: $elm$core$Maybe$Just('16'),
					width: $elm$core$Maybe$Just('16')
				})),
			$rtfeldman$elm_css$Html$Styled$text('Add Goal')
		]));
var $author$project$Tailwind$Theme$gray_100 = A5($matheus23$elm_tailwind_modules_base$Tailwind$Color$Color, 'rgb', '243', '244', '246', $matheus23$elm_tailwind_modules_base$Tailwind$Color$ViaVariable);
...
var $author$project$Tailwind$Utilities$py_0_dot_5 = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, 'padding-top', '0.125rem'),
			A2($rtfeldman$elm_css$Css$property, 'padding-bottom', '0.125rem')
		]));
var $author$project$Tailwind$Utilities$rounded_full = A2($rtfeldman$elm_css$Css$property, 'border-radius', '9999px');
var $rtfeldman$elm_css$Html$Styled$span = $rtfeldman$elm_css$Html$Styled$node('span');
var $author$project$Main$viewBadge = function (text) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Tailwind$Utilities$py_0_dot_5,
						$author$project$Tailwind$Utilities$text_xs,
						$author$project$Tailwind$Utilities$font_semibold
					]))
			]),
	...
	return $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				...
				$elm$core$Maybe$Just('--tw-border-opacity, 1'),
				color)
			]));
};
var $author$project$Tailwind$Theme$gray_300 = A5($matheus23$elm_tailwind_modules_base$Tailwind$Color$Color, 'rgb', '209', '213', '219', $matheus23$elm_tailwind_modules_base$Tailwind$Color$ViaVariable);
var $author$project$Tailwind$Theme$white = A5($matheus23$elm_tailwind_modules_base$Tailwind$Color$Color, 'rgb', '255', '255', '255', $matheus23$elm_tailwind_modules_base$Tailwind$Color$ViaVariable);
var $author$project$Main$viewOutlinedBadge = function (text) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$span,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Tailwind$Utilities$border,
						$author$project$Tailwind$Utilities$border_color($author$project$Tailwind$Theme$gray_300),
...
var $author$project$Main$view = function (_v0) {
	return $author$project$StyledHtml$styledHtml(
		A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Tailwind$Utilities$m_8]))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$author$project$Tailwind$Utilities$shadow, $author$project$Tailwind$Utilities$rounded]))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[$author$project$Tailwind$Utilities$flex, $author$project$Tailwind$Utilities$items_center, $author$project$Tailwind$Utilities$gap_2, $author$project$Tailwind$Utilities$border_b, $author$project$Tailwind$Utilities$p_4]))
								]),
							_List_fromArray(
								[
									$author$project$Icons$target(
									$elm$core$Maybe$Just(
										{
											height: $elm$core$Maybe$Just('20'),
											width: $elm$core$Maybe$Just('20')
										})),
									$rtfeldman$elm_css$Html$Styled$text('Team Goals'),
									$author$project$Main$viewBadge('0 / 1 completed'),
									$author$project$Main$viewOutlinedBadge('2025-05-29')
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$section,
							_List_fromArray(
							...
							_List_fromArray(
								[$author$project$Main$viewAddGoalButton]))
						]))
				])));
};
